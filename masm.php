...
<div class='input-group' style='margin-bottom:10px;' >
   ...
   <select  name='medstype'  id='schemefilter2' class="schemefilter2" style='height:30px; width: 100%' >
   	                                <option>MASM</option>            				       
              ...
              <tr class="warning" style="font-weight: bold">
                ...
                <td >Bill</td>             
               	 ...
               	 <?php   
			           ...
			           $schecost=0;$costtotal=0;$cost='';$count=0;
               	 $sqlmember ="SELECT * FROM tbl_petients  ";
...
$sqld ="SELECT * FROM tbl_treatment WHERE Status='Closed' && Progress='Notpaid' && Patientid='$id' ";
$retrievesd = mysqli_query($db,$sqld);
	$numd=mysqli_num_rows($retrievesd);
if($numd!=0){ 
				   
        $sqldx ="SELECT * FROM tbl_transactions WHERE Payment='MASM' && Patientid='$id' ";
